...
public class FlightOfKayak {
	...
	@FindBy(css="span[class$='js-selection-display _h-8 _iQe _kaM _ic2 _ic3']")
	public List<WebElement> destinationText;//0
	...
	@FindBy(xpath=" //*[contains(@id,'price_aTab')]/div[1]/div/div/div[1]/div/span/span")
